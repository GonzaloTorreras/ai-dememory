...
4. **Five-minute stable setup:** PyPI, vault, health, setup-plan, wizard and
   MCP commands with no hidden side effects.
...
- Complete the stable setup-plan, preview-first wizard and client path.
