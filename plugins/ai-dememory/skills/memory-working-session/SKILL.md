...
description: "Maintain generated working state and handoffs from ai-dememory through MCP or CLI tools. Use when the user asks to remember current task state, prepare a handoff, resume recent work, summarize a session, or update local working memory without promoting durable facts."
---
